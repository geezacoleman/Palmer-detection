...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--v5-metric', action='store_true', help='Use v5 Metrics')
...
def run(data,
    ...
    val = Evaler(data,
                 ...
                 letterbox_return_int=letterbox_return_int,
                 force_no_pad=force_no_pad,
                 not_infer_on_rect=not_infer_on_rect,
