...
# updated to match experiments in other YOLO versions
eval_params = dict(
    batch_size=8,  # None mean will be the same as batch on one device * 2
    img_size=None,  #None mean will be the same as train image size
    conf_thres=0.001,
    iou_thres=0.60,

    #pading and scale coord
    test_load_size=1280, #None mean will be the same as test image size
